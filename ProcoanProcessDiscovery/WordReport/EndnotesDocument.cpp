...
EndnotesDocument::EndnotesDocument() :DocXDocPart("word", "endnotes.xml")
{
	endnoteID = -1;
	mainTag = AddTag("w:endnotes");
...
void EndnotesDocument::AddEndnoteSeperator()
{
	DocXTag *pTag = mainTag->AddTag("w:endnote");
	pTag->AddAttribute("w:id", endnoteID);
...
void EndnotesDocument::AddEndnoteContinuousSeperator()
{
	DocXTag *pTag = mainTag->AddTag("w:endnote");
	pTag->AddAttribute("w:id", endnoteID);
